...
namespace LotroMusicManager
{
    public class Song
    {
        ...
        public String ShortName     {private set {return;} 
            get {return FileName.Substring((Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + Resources.MusicSubfolder).Length);}}
        public String ToolTip       {private set {return;} 
        ...
        {   //====================================================================
            ...
            Regex regexStart = new Regex(Resources.ABCTagIndex + @"\s*" + Index + @"\s");
            Match matchStart = regexStart.Match(s);
            int iEndPartOne = matchStart.Index;

            Regex regexEnd = new Regex(Resources.ABCTagIndex + @"\s*\d");
        ...
        {   //====================================================================
            ...
            do
            {
                iEnd = s.IndexOf(Resources.ABCTagIndex, iStart + 1, StringComparison.CurrentCultureIgnoreCase);
